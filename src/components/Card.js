...
function Cart (props) {
    ...
    return(
        <div className="catalog-card">
            <img src={props.imgUrl} alt="sneakers" className="catalog-card__img"/>
            <div className="catalog-card__description">
                <p className="catalog-card__description-caption">Мужские Кроссовки</p>
                <p className="catalog-card__description-name">{props.title}</p>
            </div>
            <div className="catalog-card-wrap">
                <div className="catalog-card__price">
                    <p className="catalog-card__price-txt">Цена:</p>
                    <p className="catalog-card__price-cost">{props.price} руб.</p>
                </div>
                <div className={isAdded ? "catalog-card__check catalog-card__check-active" : "catalog-card__check"} onClick={onClickPlus}>
                    <svg className="plus" style={isAdded ? {display: "none"} : {display: "block"}} width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg className="check" style={isAdded ? {display: "block"} : {display: "none"}} width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="catalog-card__favorite" onClick={props.onClickFavorite}>
